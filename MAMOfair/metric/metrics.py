...
class EqOportunity(Metric):

    def __init__(self, name='EO', weight_vector=None, \
                 threshold=0.5, attribute_index=1):
    ...
    def evaluate(self, y_true, y_pred, x, model):
        ...
        EO = min(TPR_0/TPR_1, TPR_1/TPR_0)
        return(np.round(EO, 20))
...
class CoVariation(Metric):

    def __init__(self, name='CV', weight_vector=None, \
                 threshold=0.5, attribute_index=1):
    ...
    def generalized_entropy_index(self, y_true, y_pred, alpha=2, target=1):
    ...
    def evaluate(self, y_true, y_pred, x, model):
        ...
        return 2*(self.generalized_entropy_index(y_true, y_pred, alpha=2, target=1)**0.5)
